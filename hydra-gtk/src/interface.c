...
GtkWidget *create_wndMain(void) {
  ...
  gtk_widget_set_tooltip_text(chkLocal, "Just attack local accounts");
  ...
  gtk_widget_set_tooltip_text(chkDomain, "Attack domain and local accounts");
  ...
  gtk_widget_set_tooltip_text(chkNTLM, "Interpret passes as NTML hashes");
  ...
  gtk_widget_set_tooltip_text(entTelnet, "Insert the return string for a succesfull login");
